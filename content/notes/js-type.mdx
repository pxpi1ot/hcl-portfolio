...
```javascript /age/#v /name/#v /setAge/#s /setName/#s /50/#i /"Taylor"/#i
...
[JavaScript Performance](https://frontendmasters.com/courses/web-performance/how-web-pages-are-built/)